...
\frac{1}{2^{\frac{t}{2}}}\sum_{j=0}^{2^t-1}e^{2\pi i \phi j}|j\rangle\otimes|\psi\rangle \rightarrow |\tilde{\phi}\rangle\otimes|\psi\rangle,
$$
...
\newpage
\appendix
\section{First half of the mathematical computation of first register evolution in the phase estimation algorithm}\label{app:A}
Given $$
...
$$
$$
=\boxed{\frac{1}{2^{\frac{t}{2}}}\sum_{k=0}^{2^t-1}e^{2\pi i \phi k}|k\rangle.}
$$
\end{document}